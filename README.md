# Game AI - Tugas Praktikum

Repositori ini berisi kumpulan tugas praktikum mata kuliah **Game AI / Kecerdasan Buatan** yang dikembangkan menggunakan **Unity**.
...
4. Pilih scene yang ingin dijalankan di `Assets/Scenes/`.
